...
class VsamRecordTest {
    ...
    @Test
    void recordCannotBeCreatedFromIllegalBytes() throws VsamRecordException, UnsupportedEncodingException {
    ...
    @Test
    void recordBytesThatExceedLengthOfRecordCannotBeCreated() throws VsamRecordException, UnsupportedEncodingException {
        String serviceId = "Service";
